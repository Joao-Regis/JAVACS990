...
public class CourseRecordsFileManager
{
    ...
    */
    ...
    public void CreateCourseFile(Course aCourse) throws IOException
    {
    ...
    */
    ...
    public Course ReadCourseFile(int courseNumID) throws IOException
    {

        int recordNumber = courseNumID;     // Record number
