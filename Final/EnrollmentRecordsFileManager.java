...
public class EnrollmentRecordsFileManager 
{
    ...
    */
    ...
    public void CreateEnrollmentFile(Enrollment aEnrollment) throws IOException
    {

        // move file pointer to eof to append new enrollment.
        moveFilePointer(getNumberOfRecords());

        writeEnrollment(aEnrollment);
    }
    ...
    */
    ...
    public Enrollment ReadEnrollmentFile(int enrollmentNumID) throws IOException
    {
        int recordNumber = enrollmentNumID;     // Record number
