...
public class tabPaneController
{
    ...
    public void handleBtnClick(MouseEvent mouseEvent) throws IOException {
        ...
        if(mouseEvent.getSource() == btnStudentSearch)
        {
            ...
            //int ReturnedStudentID = student.getStid();
            //String convertedReturnedStudentID = Integer.toString(ReturnedStudentID);
        ...
        if(mouseEvent.getSource() == btnAddCreateCourse)
        {
            ...
            String crsInstructor = txtFldCourseInstructorSearchResult.getText();
            String crsDept = txtFldStudentCity.getText();
            String crsNum = txtFieldStudentState.getText();

            Course course = new Course(crsName, crsInstructor, crsDept, crsNum);
            sfile.CreateStudentFile(student);
    ...
    //{
       ...
       /* StudentRecordsFileManager sfile =
        ...
        /*public StudentInformationSystem() throws FileNotFoundException
        {
...
/*        do
    ...
    /* public static void viewGradesByStudent(StudentRecordsFileManager aFile, int stid) {
        ...
        public static void ReadstudentFile(StudentRecordsFileManager aFile, int studentNumID) throws IOException
        {
